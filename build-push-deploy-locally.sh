...
echo ""
echo "Running: push local-registry:5000/atom-operator:$TAG"
docker push "local-registry:5000/atom-operator:$TAG"
...
echo ""
echo "Running: deploy IMG=local-registry:5000/atom-operator:$TAG"
make deploy "IMG=local-registry:5000/atom-operator:$TAG"