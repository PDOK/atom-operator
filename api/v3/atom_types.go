...
type AtomStatus struct {
	...
	// conditions represent the current state of the Atom resource.
...
type Atom struct {
	...
	// spec defines the desired state of Atom
	// +required
	Spec AtomSpec `json:"spec"`

	// status defines the observed state of Atom
	// +optional
	Status AtomStatus `json:"status,omitzero"`
}
